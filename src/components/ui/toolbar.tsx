...
>(({ className, ...props }, ref) => (
  <ToolbarPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex select-none items-center gap-1 overflow-hidden rounded-xl border border-gray-200 bg-white/95 backdrop-blur-md p-1 text-gray-950 shadow-md",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToolbarPrimitive.Separator
    ref={ref}
    className={cn("mx-1 h-4 w-px bg-gray-200", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToolbarPrimitive.Button
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-gray-100 hover:text-gray-900",
      className
    )}
    {...props}
  />
